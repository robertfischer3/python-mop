...
class PolicyInsights:
    ...
    def policy_insights_client_query(self, subscription_id_param, policy_states='latest'):
        ...
        query_results = states.list_query_results_for_subscription(subscription_id=subscription_id_param,
    ...
    def subscription_policy_list(self, subscription_id_param) -> list:
        ...
        :return:
        '''
        policy_client = PolicyClient(credentials=self.credentials, subscription_id=subscription_id_param, base_url=None)
        policy_definitions = policy_client.policy_definitions.list(custom_headers=None, raw=False)
        policy_defs_limited = [
            [policy.metadata.get("category"), policy.policy_type, policy.display_name, policy.name, policy.description]
            for
            policy in policy_definitions]
    ...
    def mapped_columns_policy_insights(raw_policy_insights_management_grp_query):
        ...
        mapped_policy_insights = [[policy_insight.is_compliant,
                                   ...
                                   policy_insight.timestamp] for policy_insight in policy_insights]
